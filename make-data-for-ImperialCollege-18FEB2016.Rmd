...
Want to create a data set that will be shared with Imperial College. For this data, only the gene expression values will be shared, along with laboratory information and case-control status/matching id. They will also have the histology-code. 
...
## Save data to file:
files <- file.path("/project/data1/tice/LungNowacMethylation/Smoking", paste0("nowac_lung_cancer_GE_for_ImperialCollege_n=256_p=11610_18FEB2016.Rdata"))
if(file.exists(files))
{
  print("File already exists. Can not save.")
} else {
  print(paste("saving data to file",files,sep=" "))
  save(labInfo,log2normData, file=files)  
}
```
